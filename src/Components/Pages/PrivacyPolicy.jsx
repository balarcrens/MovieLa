...
export default function PrivacyPolicy() {
    return (
        <>
            <Helmet>
                <title>Privacy Policy | Moviela</title>

                <meta
                    name="description"
                    content="Read Moviela’s privacy policy to understand how we collect, use, and protect user information while using our website."
                />
                ...
                <link
                    rel="canonical"
                    href="https://moviela.vercel.app/privacy-policy"
                />

                {/* Open Graph (optional but good) */}
                <meta property="og:title" content="Privacy Policy | Moviela" />
                <meta
                    property="og:description"
                    content="Learn how Moviela handles user data, cookies, advertising technologies, and privacy protection."
                />
                <meta
                    property="og:url"
                    content="https://moviela.vercel.app/privacy-policy"
                />
